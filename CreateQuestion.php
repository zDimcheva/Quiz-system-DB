...
<form method="post">
  <div class="container">
    ...
    <p>Please fill in this form to create the questions.</p>
    <p><strong>&starf;&starf;&starf; All fields must be filled.</strong></p>
    <hr>
  ...
  <div>
    <p>Go back to main page: <a href="MainPageStaff.php">Main Page</a>.</p>
  </div>
</form>

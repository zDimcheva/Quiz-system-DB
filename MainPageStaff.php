...
<body>
	...
	if(isset($_POST['take']) && !empty($_POST['number'])) {	
	    ...
	    $stmt->execute(['QuizID' => $_SESSION['quizTaken']]);
		...
		echo '<script>alert("No questions in the quiz. Try another one!")</script>';
	    }
	}
	if(isset($_POST['create'])) {	
            header("Location: http://localhost/scripts/CreateQuiz.php");
            exit; 
	}
...
<div class="container">
 <h1>Main Staff Page</h1>
  <h2>Welcome to our main page. You can use this page to navigate through the available options.</h2>
    <p>Please choose one of the options below.</p>
      <hr>

         <label for="quiz"><b>If you want to do one of the quizzes, please enter the number of the quiz you want to take click the button below.</b></label><br><br>
	 <input type="number" min="0" placeholder="Enter Quiz Number" name="number" id="number"><br><br>
	 <p>These are all quizzes to take:</p>
    ...
    ?>
	 ...
	 <hr>
         <label for="results"><b>If you want to create quiz and questions, please click the button below.</b></label>
	 <button type="submit" class="registerbtn" name="create">Create</button>
	 <hr>
         <label for="results"><b>If you want to update or delete a quiz and/or questions related to it, please click the button below.</b></label>
